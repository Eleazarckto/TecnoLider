...
class _OperatorScreenState extends State<OperatorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppShell(
      userName: user.name,
      userRoleLabel: 'Operador',
      userSubtitle: 'Central de despacho',
      onLogout: _logout,
      roleColor: DS.accent,
      items: [
        const NavItem(
        ...
        NavItem(
          ...
          body: const _ToQuoteTab(),
          badge: toQuoteCount > 0 ? toQuoteCount : null,
        ),
        NavItem(
          label: 'Pendientes',
          icon: Icons.schedule,
  ...
  Widget build(BuildContext context) {
    ...
    if (pending.isEmpty) {
      return const EmptyState(
        ...
        hint:
            'Las órdenes nuevas que envíen las empresas aparecerán aquí para que las asignes a un motorizado.',
      );
    }
          ...
          children: [
            ...
            if (riders.isEmpty)
              Padding(
                ...
                child: Text(
                  'No hay motorizados registrados. Pide al administrador que agregue al menos uno.',
                    ...
                    return Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          Navigator.pop(ctx);
                          showSuccessSnack(
                              context, 'Orden #${order.number} asignada a ${r.name}');
                        },
                        child: Container(
                          padding: const EdgeInsets.all(DS.space3),
                          decoration: BoxDecoration(
